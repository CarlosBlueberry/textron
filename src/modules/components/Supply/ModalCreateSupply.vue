<template>
  <div class="modal fade" id="add-supply" tabindex="-1" aria-labelledby="add-updateLabel" aria-hidden="true">
          ...
          <div class="row">
            ...
            <div class="col-9">
              <div class="text-center">
                <h3 class="oExtraBold text-light">Submit your new module</h3>
              </div>
            </div>
            <div class="col-1">
              ...
              <div class="col-12 col-sm-12 col-md-12 col-lg-10">
                <div class="">
                  <form @submit.prevent="addBusiness" class="form-add-update oRegular">
                    <div class="mb-3">
                      <label for="title" class="form-label">Create new module:</label>
